...
/*Helfen*/
/*
el primer grupo de if permite aumentar el angulo de cualquiera de los 5 servos con los que cuenta el brayo mientras 
que el segundo if permite reducir el angulo de los mismos la funcion  void Automatisch(LLetzterPosicion, NeuesPosition,
ServoName, WebegungZeit, Pause); solo es valida para la funcion de automatico 

la funcion conpara la posicion incial con la nueva para decidir si tiene que ampliar el angulo o disminuirlo despues 
cuenta con dos delay con los que controla la velocidad conla que realiza la transicion de la pocision inicial a la
posicion final y la pausa hasta el siguiente movimiento 
*/
